				...
				sections = {
					'faq': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-G16MGE5LVS', { 'page_path': '/#faq' });
								},
							],
						},
					},
					'grouporder': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-G16MGE5LVS', { 'page_path': '/#grouporder' });
								},
							],
						},
					},
					'mods': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-G16MGE5LVS', { 'page_path': '/#mods' });
								},
							],
						},
					},
					'schedule': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-G16MGE5LVS', { 'page_path': '/#schedule' });
								},
							],
						},
					},
					'home': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-G16MGE5LVS', { 'page_path': '/' });
								},
							],
						},
					},
